...
```{r}
con <- dbConnect(RSQLite::SQLite(), "/scratch/midway3/temi/lEnpact/standing_height_2025-01-10/standing_height/FOSL1_Breast/models/filtered_db/predict_db_standing_height_filtered.db")
dbListTables(con)
```
...
```{r}
sumstats <- data.table::fread('/beagle3/haky/users/temi/projects/TFXcan-snakemake/data/standing_height_2025-01-10/processed_sumstats/standing_height/chr21.sumstats.txt.gz')
```
