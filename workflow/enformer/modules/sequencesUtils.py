...
def extract_reference_sequence(region, fasta_func=None, resize_for_enformer=True, resize_length=None, print_sequence = False, write_log=None, error_file=None):
...
def create_input_for_enformer(query_region, samples, path_to_vcf, fasta_func, hap_type = 'both', resize_for_enformer=True, resize_length=None, write_log=None, sequence_source=None, reverse_complement=False, error_file=None):
    '''
    ...
    if sequence_source == 'random':
        ...
        reference_sequence = extract_reference_sequence(region=query_region, fasta_func=fasta_func, resize_for_enformer=resize_for_enformer, write_log=write_log, resize_length=resize_length, error_file=error_file)
